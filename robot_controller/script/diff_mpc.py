...
class SimplePoseController:
    def __init__(self):
        ...
        self.Q = np.diag([10, 10, 1])  # State weighting matrix
        ...
        self.state_dot = ca.vertcat(self.v * ca.cos(self.theta), self.v * ca.sin(self.theta), self.omega)
        ...
        self.v_min = -1
        self.v_max = 1
        self.omega_min = -ca.pi/2
        self.omega_max = ca.pi/2
    ...
    def solve_mpc(self, x0, x_ref):
        ...
        U = opti.variable(2, self.N)      # control: [v, omega]
        ...
        opti.subject_to(opti.bounded(self.omega_min, U[1, :], self.omega_max))
    ...
    def publish_trajectory(self, X_pred):
        ...
        # marker.quaternion_from_euler(roll, pitch, yaw)
